...
public function init()
    ...
    {   
    	if($this->getRequest()->isPost()){   
    		...
    		$db_adjust= new Product_Model_DbTable_DbRequestStock();
...
// 		$sql .= " GROUP BY p.pro_id,pt.type_id";
	...
	public function transferStockAction()
	{
		if($this->getRequest()->isPost()){
			$post=$this->getRequest()->getPost();
			$transfer_stock = new Product_Model_DbTable_DbRequestStock();
...
// 			$this->_redirect("product/adjust-stock/index");
	...
	public function adjustPriceAction()
	{
		...
		{	
			...
			if($post['save']!=="")
			{
				$adjust_price = new Product_Model_DbTable_DbRequestStock();
	...
	public function getCurrentQuantityAction(){
		...
		$post=$this->getRequest()->getPost();
 		$get_item = new Product_Model_DbTable_DbRequestStock();

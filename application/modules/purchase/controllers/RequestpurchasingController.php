<?php
class Purchase_RequestpurchasingController extends Zend_Controller_Action
{	
...
//     	}
	...
	public function indexAction()
	{
		...
		$db = new Purchase_Model_DbTable_DbRequestpurchasing();
		...
		$link=array(
				'module'=>'purchase','controller'=>'requestpurchasing','action'=>'edit',
		);
		...
		if($this->getRequest()->isPost()) {
			...
			Application_Form_FrmMessage::message("Purchase has been Saved!");
				if(!empty($data['btnsavenew'])){
					Application_Form_FrmMessage::redirectUrl("/purchase/requestpurchasing/add");
				}
				Application_Form_FrmMessage::redirectUrl("/purchase/requestpurchasing/");
			}catch (Exception $e){
